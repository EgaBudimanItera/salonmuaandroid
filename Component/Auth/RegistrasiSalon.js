...
class RegistrasiSalon extends Component {
  ...
  registrasi() {
    if (this.state.username === "" && this.state.password === "") {
      ...
      const url = Server + "/api.php?operasi=register_salon";
      fetch(url, {
        method: "post",
        body: data
      }).then(() => {
        ...
        <Container style={{ flex: 2, marginTop: 5 }}>
          <Content>
            ...
            <Text style={{ margin: 10, textAlign: "center" }}>
              Pastikan Anda Berada Di Lokasi Salon Anda
            </Text>
...
RegistrasiSalon.propTypes = {
  provider: MapView.ProviderPropType
};

export default withNavigation(RegistrasiSalon);
