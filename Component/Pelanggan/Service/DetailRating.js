...
class DetailRating extends Component {
  ...
  showDetailRating = () => {
    axios
      .get(Server + `api.php?operasi=show_detail_rating&data=${id_salon}`)
      .then(res => {
        this.setState({
  ...
  saveRating() {
    axios
      .get(
        Server +
          `api.php?operasi=input_rating&id_salon=${id_salon}
      &id_pendaftaran=${this.props.id_admin.id_admin}&rating=${
