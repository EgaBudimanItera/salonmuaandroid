...
class EditProfil extends Component {
  ...
  getData = () => {
    axios
      .get(
        Server +
          `api.php?operasi=detail_salonuser&data=${this.props.id_admin.id_admin}`
      )
      .then(respon => {
  ...
  EditData() {
    ...
    const url = Server + "/api.php?operasi=ubah_profil_salon";
    fetch(url, {
      method: "post",
      body: data
    }).then(() => {
                ...
                <View style={styles.ImageContainer}>
                  {this.state.ImageSource === null ? (
                    <Image
                      ...
                      source={{
                        uri: Server + "images/" + this.state.foto_salon
                      }}
                    />
                  ) : (
                    <Image
