...
class HeaderSalon extends Component {
  _logOut = async () => {
    try {
      ...
      <View style={styles.container}>
        ...
        <Container>
          <Content horizontal>
            ...
            <TouchableOpacity
              onPress={() => {
                this.props.navigation.navigate("PemesananSalon");
              }}
            >
              <View style={styles.menu}>
                <Thumbnail
                ...
                />
                <View style={styles.garisHeader} />
                <Text style={{ fontSize: 14 }}>Pemesanan</Text>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              onPress={() => {
                this.props.navigation.navigate("FotoSalon");
              }}
            >
              <View style={styles.menu}>
                <Thumbnail
...
export default withNavigation(HeaderSalon);
