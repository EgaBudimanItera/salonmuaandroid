...
MySQL - 10.1.34-MariaDB : Database - smar8971_salon
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`smar8971_salon` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
/*Table structure for table `tbl_jenis_jasa` */
...
/*Data for the table `tbl_jenis_jasa` */
...
insert  into `tbl_order`(`id_order`,`tanggal`,`id_jenis_jasa`,`id_pendaftar`,`harga`,`jml_harga`,`lat_user`,`lng_user`,`status`,`biaya_transportasi`,`jam`,`status_pesanan`) values 
(5,'    ',23,20,'150000    ','174000    ','-5.3965399    ','105.2615557    ','Datang Ke Rumah   ','24000    ',' 05:39:00','Proses'),
(7,'    ',26,20,'100000    ','120000    ','-5.3803786    ','105.2545942    ','Datang Ke Rumah ','20000    ',' 11:39:00','Proses'),
(16,'29-08-2019    ',19,22,'1500000    ','1500000    ','-5.3830165    ','105.2580401    ','Datang Ke Tempat','0    ',' 04:47:00','Proses'),
...
(24,'30-08-2019    ',19,18,'1500000     ','1545000    ','-5.34586132    ','105.24609331    ','Datang Ke Rumah  ','45000    ',' 05:35:00','Proses'),
(25,'28-08-2019    ',22,22,'150000    ','175000    ','-5.4142711    ','105.2551453    ','Datang Ke Rumah   ','25000    ',' 05:40:00','Pesanan Di Konfirmasi Salon'),
(28,'13-08-2019    ',21,27,'150000    ','175000    ','-5.3830153    ','105.2580284    ','Datang Ke Rumah   ','25000    ',' 06:00:00','Proses'),
...
(35,'22-09-2019    ',19,18,'1500000     ','1500000     ','37.421998333333335    ','-122.08400000000002    ','Datang Ke Tempat    ','0    ',' 11:57:00','Proses'),
...
(43,'01-10-2019    ',37,30,'150000    ','150000    ','-5.386555    ','105.2589882    ','Datang Ke Tempat    ','0    ',' 17:00:00','Pesanan Di Konfirmasi Salon'),
...
/*Data for the table `tbl_salon` */

insert  into `tbl_salon`(`id_salon`,`nama`,`alamat`,`no_telp`,`email`,`foto`,`pemilik`,`lat`,`lng`) values 
(1,'Mutiara intana makeup','jln wolter mangonsidi no.198 bandar lampung','089631072185','mutiara@gmail.com','image-7d7ae255-29a3-4a5b-9fd4-36eb726fbf6e.jpg','Mutiara','-5.423230','105.251510'),
(4,'Ayudia Makeup','Jln. Bukit kemiling permai blok t nawar no76','08526892279','Ayudia@gmail.com','ayudia.jpg','Ayudia','-5.380600','105.214460'),
(5,'Mumayizah Makeup ','Jln. Mawar merah, harapan Jaya kecamatan sukarame bandar lampung ','085841912901','Mumayizah@gmail.com','muwawijah.jpg','Mumayizah','-5.369300','105.298960'),
(6,'Allforyou Makeup ','Jl.rajabasa','081271108454','Allforyou@gmail.com','allforyou.png','Allforyou ','-5.3743992','105.2309282'),
(7,'Aan Mua','Jln. Ruko kamboja no 2 J. A salon (depan yayasan budi luhur / samping alfamart) ','08117995050','Aan@gmail.com','aan.jpg','Aan mua','-5.356450','105.253270'),
(10,'Rika Ridayanti MUA','Jl. Perumahan bering raya, kemiling','08996411951','rika@gmail.com','rika.png','RIka','-5.397120','105.206510'),
(11,'Annisa MUA','Jl.mr.moch.roem (dekat hotel Sheraton)','08121245678','anisa@gmail.com','anisa.png','Anisa','-5.429750','105.262270'),
(12,'Anastasia mua','jln kimaja no.22 wayhalim','08221256889','anastasia@gmail.com','anastia.jpg','Anastasia ','-5.377040','105.278610'),
(13,'Hani mua','jln  teuku umar 100 meter setelah rs advent (di kittyhijab)','082281195559','hani@gmail.com','hani.jpg','Hani','-5.429750','105.262270'),
(14,'Salon intan ','jln raden intan no 56 tanjung karang, Bandar lampung','085269225350','intan@gmail.com','intan.png','Hendra Bhastian','-5.416230','105.258310'),
(15,'Christella salon','jln ratu dibalau, way kandis, tanjung senang Bandar lampung','08223435678','cSalon@mail.com','p.png','Christella ','-5.354580','105.289421'),
(16,'Althaf makeup','jln sadewo no.64 sawah lama, tanjung karang timur Bandar lampung','0813112346786','Althaf@gmail.com','yt.jpg','Althaf ','-5.409200','105.265472'),
(17,'Donna Endro Mua','Jl Wartawan Gg.Manis No.1 D Gunung Sulah, Sukarame','081369569494','donnaendro@gmail.com','donna.jpg','Donna','-5.392295','105.273383'),
(21,'Soraya Makeup','Jalan Ikan Paus no. 56 Teluk Betung Selatan','08975155116','makeupbysoraya@gmail.com','m.jpg','Soraya','-5.446745','105.2584'),
(24,'Ulfa Makeup ','jl Kaliawi, kec. Tanjung karang pusat','082182929921','ulfarizqi@gmail.com','ulfamua.jpg','Ulfa Rizqi','-5.412316','105.241926'),
(25,'Shine makeup','Jl Tunggul Ametung no.41, kedaton','081283260707','Monaistiara@gmail.com','image-3d89e3bd-5f22-4b0a-9c1b-04bf7c0a83a2.jpg','Mona Istiara','-5.383573','105.262432'),
(26,'Anjun Herly','Jl Hi.Khomarudin Gg.Nitiuda Rajabasa Raya ','08123456789','anjunherly@gmail.com','anjun.jpg','Anjun Herly','-5.355305','105.239750'),
(31,'Beauty salon','Jl za pagar alam kedaton no9-11','081245312798','Beauty@gmail.com','image-60366d0e-fa5a-434f-b611-19a5c572ace8.jpg','Vera','-5.386555','105.2589882');

/*Table structure for table `tbl_salon_terdekat` */

DROP TABLE IF EXISTS `tbl_salon_terdekat`;

CREATE TABLE `tbl_salon_terdekat` (
...
/*Data for the table `tbl_salon_terdekat` */
...
/*Data for the table `tbl_user_admin` */
